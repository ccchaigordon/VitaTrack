  ...
  return (
    <>
      <nav className="sticky top-0 z-50 flex items-center justify-between bg-white px-4 xl:px-10 py-3 shadow-[0px_4px_6px_-2px_rgba(0,0,0,0.1)] rounded-b-xl">
        ...
        <ul className="hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform items-center space-x-6 lg:mx-auto lg:flex lg:w-auto">
          <li>
        ...
        <div className="relative hidden lg:block" ref={profileRef}>
          ...
          >
            ...
            <svg
              className={`ml-8 h-4 w-4 text-[#1A381D]/70 transition-transform duration-200 ${
